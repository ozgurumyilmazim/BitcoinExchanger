                ...
                <div class="scrollbar-inner">
                    ...
                    <div class="user">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="profile.ph">View Profile</a>
                    ...
                    <ul class="navigation">
                        ...
                        <li><a href="exchange.php"><i class="zmdi zmdi-widgets"></i>Exchange</a></li>

                        <li><a href="available_coins.php"><i class="zmdi zmdi-format-underlined"></i>Available Coins</a></li>

                       <!-- <li><a href="currency_prices.php"><i class="zmdi zmdi-format-underlined"></i>Cryptocurrency Prices</a></li>-->

                         <li><a href="market_rate.php"><i class="zmdi zmdi-widgets"></i> Market Rate</a></li>
                       <!-- <li><a href="transactions.php"><i class="zmdi zmdi-widgets"></i> Transactions</a></li>-->

                        <li><a href="activities.php"><i class="zmdi zmdi-view-list"></i> Activities</a></li>

                         <li><a href="transaction_status.php"><i class="zmdi zmdi-format-underlined"></i>Transaction Status</a></li>
