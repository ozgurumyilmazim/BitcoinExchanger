...
if(isset($_GET['email']) && !empty($_GET['email']) AND isset($_GET['hash']) && !empty($_GET['hash'])){
    ...
    if($match > 0){
      ...
      $query = mysqli_query($connection , $sql);
       if($query===true){
        $em[] = "Your account has been activated please use log in details";
    }else{
        // No match -> invalid url or account has already been activated.
       $em[] = "The url is either invalid or you already have activated your account";
    }
                 
    }else{
    // Invalid approach
    $em[] =  "Invalid approach, please use the link that has been send to your email";
        ...
        <div class="login">
            ...
            <div class="login__block active" id="l-login">
                ...
                <div class="login__block__body">
                    ...
                    <a href="index.php" class="btn btn--icon login__block__btn"><i class="zmdi zmdi-long-arrow-right"></i></a>
                </div>
            </div>
