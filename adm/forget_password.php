...
if(isset($_POST) & !empty($_POST)){
    ...
    if($count == 1){
        ...
        $headers = "From : inf@onexchange.io";

        if(mail($to, $subject, $message, $headers)){
            $em[] ="Your Password has been sent to your email id";
        }else{
            $em[] = "Failed to Recover your password, try again";
        }
 
    }else{
        $em[] = "User name does not exist in database";
    }
}
